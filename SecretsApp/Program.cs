...
Secret<SecretData> kv3Secret = await vaultClient.V1.Secrets.KeyValue.V2
     .ReadSecretAsync(path: "Du_Må_Ikke_Sige_Det_Til_Nogen", mountPoint: "secret");

var Penis1 = kv3Secret.Data.Data["Penis1"];
Console.WriteLine($"Min Penis Er: {Penis1}");

var Penis2 = kv3Secret.Data.Data["Penis2"];
Console.WriteLine($"Min Penis Er: {Penis2}");